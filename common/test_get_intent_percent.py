...
class GetPercent:
    ...
    def get_test_env_request(self):
        ...
        GetIntent.get_intent(self, "http://192.168.1.79:8900/intention/v2/tcnn?utterance={}",
                             "intent\\rxk_about_two_target.txt",
                             "rxk_case_all.csv",
                             "rxk_all_test_result.xls", "rxk_test_target_result.xls")

        # 耳鼻喉意图测试
        GetIntent.get_intent(self, "http://192.168.1.79:8900/intention/v2/tcnn?utterance={}",
                             "intent\\otolaryngology\\ehb_about_two_target.txt",
                             "otolaryngology\\ebh_case_all.csv",
                             "ebh_all_test_result.xls", "ebh_test_target_result.xls")
