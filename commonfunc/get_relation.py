...
class GetRelation:
    ...
    def get_answer(self, file):
       ...
       """
        ...
        # 保存表格
        workbook.save(rootPath + '\\testresults\\resultfile\\' + "1answer_collection_result.xls")
    ...
    def get_question(self, file):
        ...
        # 保存表格
        workbook.save(rootPath + '\\testresults\\resultfile\\' + "1question_collection_result.xls")
